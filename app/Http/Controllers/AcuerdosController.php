...
class AcuerdosController extends Controller
{
    public function index()
    {
        ...
        // Aquí asegúrate de pasar la variable a la vista que renderiza container.blade.php
        return view('instrumentoslegales.acuerdos.index', compact('acuerdos', 'conteoAcuerdos'));
    }
