...
<head>
    ...
    <style>
        ...
        .container h1 { font-size: 2.5rem; margin-bottom: 30px; color: #fff; /* Cambiar el color del texto a blanco */ text-align: center; }
        ...
        .table {
            ...
            border: 2px solid #dee2e6; /* Borde de la tabla */
        }
        ...
        .table th {
            background-color:rgb(218, 26, 26); /* Color de fondo de los encabezados */
            color: #fff; /* Color del texto de los encabezados */
        }

        .table tbody tr:nth-child(even) {
            background-color: #e9ecef; /* Color de fondo de las filas pares */
        }

        .table tbody tr:nth-child(odd) {
            background-color: #fff; /* Color de fondo de las filas impares */
        }
...
<section class="intro-section py-3 animate__animated"></section>
    ...
    <header class="main-header text-center animate__animated">     
        <h3>Bienvenido! Conozca un Poco Sobre las Ordenanzas del Municipio Escuque.</h3>
    </header>

    <section class="intro-section py-3 animate__animated"></section>

    <div class="container mt-5">
        <h1 class="mb-4">Ordenanzas Municipales</h1>

        <!-- Formulario de búsqueda -->
        <form action="{{ route('legales.search') }}" method="GET">
        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="{{ asset(Storage::url($ordenanza->ruta)) }}" class="btn btn-primary btn-sm" target="_blank">Descargar</a></td>
                </tr>
                @endforeach
            </tbody>
        </table>
