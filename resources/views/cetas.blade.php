...
<div class="container">
    ...
    <header class="main-header text-center animate__animated">
        <h3>Bienvenido! Conozca un Poco Sobre las Gacetas del Municipio Escuque.</h3>
    </header>

    <section class="intro-section py-3 animate__animated"></section>

    <div class="container mt-5">
        <h1 class="mb-4">Gacetas Municipales</h1>

        <!-- Formulario de búsqueda -->
        <form action="{{ route('cetas.search') }}" method="GET">
        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $ceta->nombre }}</td>
                    <td><a href="{{ asset(Storage::url($ceta->ruta)) }}" class="btn btn-primary btn-sm" target="_blank">Descargar</a></td>
                </tr>
                @endforeach
            </tbody>
        </table>
