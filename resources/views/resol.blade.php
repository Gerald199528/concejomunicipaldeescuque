...
<section class="intro-section py-3 animate__animated"></section>
    ...
    <div class="container mt-5">
        ...
        <form action="{{ route('resol.search') }}" method="GET">
        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                @if($resol->isEmpty())
                    <tr>
                        <td colspan="3">No se encontraron resoluciones.</td>
                    </tr>
                @else
                    ...
                    <tr>
                        <td>{{ $resol->nombre }}</td>
                        <td>{{ $resol->fecha }}</td>
                        <td><a href="{{ asset(Storage::url($resol->ruta)) }}" class="btn btn-primary btn-sm" target="_blank">Descargar</a></td>
                    </tr>
                    @endforeach
                @endif
            </tbody>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 h-100 text-center text-lg-start my-auto">
                    ...
                    <p class="text-muted small mb-4 mb-lg-0">&copy; Cámara Municipal de Escuque 2025. Todos los Derechos Reservados.</p>
                </div>
