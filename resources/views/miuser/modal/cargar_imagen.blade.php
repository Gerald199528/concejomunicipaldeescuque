    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" form="upload-form">
                    <i class="fa-solid fa-arrow-up-from-bracket"></i> Importar 
                </button>
            </div>
        </div>
    </div>
    ...
    const dropzone = new Dropzone("#my-dropzone", {
        ...
        init: function() {
            this.on("addedfile", function(file) {
                ...
                let removeButton = Dropzone.createElement("<div class='text-center mt-2'><br><button class='btn btn-danger btn-sm'>Eliminar</button></div>");
