...
@section('container')
    ...
    @include('instrumentoslegales.acuerdos.modal.modal') <!-- Cambiado a acuerdos -->
    @include('instrumentoslegales.acuerdos.datatable.datatable') <!-- Cambiado a acuerdos -->
    ...
    <script>
        document.getElementById('uploadForm').addEventListener('submit', function(event) {
            const fileInput = document.getElementById('acuerdo'); // Cambiado a acuerdo
    ...
    <script>
        function printTable() {
            ...
            win.document.write('<html><head><title>Imprimir Acuerdos</title>');
