@extends('layouts.app')
@section('title', 'Cargar Ordenanzas')
@section('container')
    <!-- ./datatable -->
...
@include('instrumentoslegales.ordenanzas.modal.modal')
@include('instrumentoslegales.ordenanzas.datatable.datatable')
    ...
    $(document).ready(function() {
        ...
        <script>
            document.getElementById('uploadForm').addEventListener('submit', function(event) {
                const fileInput = document.getElementById('ordenanza');
...
function printTable() {
    ...
    win.document.write('<html><head><title>Imprimir Gasetas</title>');
