...
<div class="modal fade" id="visualizarModal" tabindex="-1" role="dialog" aria-labelledby="visualizarModalLabel" aria-hidden="true">
    ...
    <div class="card shadow-sm mb-3" style="border-radius: 10px; border: 1px solid #007bff;">
        <img id="userImagen" src="{{ isset($imagenExpediente) ? $imagenExpediente : asset('ruta/por/defecto/a/imagen.jpg') }}" alt="Imagen del usuario" class="card-img-top img-fluid rounded-circle" style="max-width: 150px; margin: 20px auto;">
        <div class="card-body">
