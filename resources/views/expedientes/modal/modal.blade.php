                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group flex-nowrap">
                                ...
                                <input type="number" class="form-control" placeholder="Ingrese Teléfono" name="telefono" id="numero_telefono" maxlength="11" required oninput="if(this.value.length > 11) this.value = this.value.slice(0, 11);">
                        ...
                        <div class="col-md-6">
                            <label for="cargo">Cargo:</label> <!-- New field for Cargo -->
                            <input type="text" class="form-control" id="cargo" name="cargo" placeholder="Ingrese el cargo" maxlength="100" required>
                        </div>
                        <div class="col-md-6">
